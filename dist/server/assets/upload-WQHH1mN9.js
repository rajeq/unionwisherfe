import { P as getDefaultExportFromCjs, r as reactExports, V as jsxRuntimeExports } from "./worker-entry-D4DgAB3i.js";
import stream from "stream";
import { c as createLucideIcon, u as useId, P as Primitive, a as composeEventHandlers, b as createContextScope, d as createCollection, e as useComposedRefs, f as useDirection, g as useControllableState, h as useCallbackRef, i as cn, j as useApp, S as Select, k as SelectTrigger, l as SelectValue, m as SelectContent, U as UNIONS, n as SelectItem, B as Button, t as toast, o as Upload, p as uploadJson, q as uploadCsv, r as uploadExcel } from "./router-D_KvtIEs.js";
          ...
          this.each(function(idx) {
            ...
            for (var i = 0; i < this.files.length; i++) {
              queue.push({
                file: this.files[i],
                inputElem: this,
                instanceConfig: $2.extend({}, config)
              });
            }
          });
          parseNextFile();
...
const isValidPhone = (p) => !!p && /^\+?[\d\s-]{7,15}$/.test(p);
function UploadPage() {
  const {
    union
  } = useApp();
  const [overrideUnion, setOverrideUnion] = reactExports.useState(union === "All" ? "Union A" : union);
    ...
    try {
      if (kind === "json") {
        ...
        Papa.parse(file, {
          header: true,
          skipEmptyLines: true,
          complete: (res) => setRows(res.data.map(normalize)),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl lg:text-3xl font-bold text-gradient-primary", children: "Upload Employee Data" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "JSON, CSV or Excel — preview and confirm." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-5 flex flex-col sm:flex-row gap-3 sm:items-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs uppercase tracking-wider text-muted-foreground", children: "Default Union for missing rows" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: overrideUnion, onValueChange: setOverrideUnion, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: applyUnion, disabled: rows.length === 0, className: "border-glass-border", children: "Apply to all rows" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "csv", className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "glass border border-glass-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "csv", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-4 h-4 mr-2" }),
          "CSV"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "excel", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileSpreadsheet, { className: "w-4 h-4 mr-2" }),
          "Excel"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "json", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileBraces, { className: "w-4 h-4 mr-2" }),
          "JSON"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "csv", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dropzone, { accept: ".csv,text/csv", onFile: (f) => handleFile(f, "csv"), kind: "CSV" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "excel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dropzone, { accept: ".xls,.xlsx", onFile: (f) => handleFile(f, "excel"), kind: "Excel" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "json", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dropzone, { accept: ".json,application/json", onFile: (f) => handleFile(f, "json"), kind: "JSON" }) })
    ] }),
    rows.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: rows.length }),
          " rows from ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: fileName }),
          invalidCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-3 inline-flex items-center gap-1 text-destructive", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => handleConfirm(), disabled: uploading, className: "gradient-primary text-primary-foreground border-0 shadow-glow", children: [
          uploading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 mr-2 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 mr-2" }),
          "Confirm Upload"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto max-h-[480px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "text-left text-xs uppercase tracking-wider text-muted-foreground bg-glass sticky top-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3", children: "#" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3", children: "Joining" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3", children: "Status" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.slice(0, 200).map((r, i) => {
            const v = validation[i];
            const ok = v.emailOk && v.phoneOk;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-glass-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-muted-foreground tabular-nums", children: i + 1 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2", children: r.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 tabular-nums " + (v.phoneOk ? "" : "text-destructive"), children: r.phone }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 " + (v.emailOk ? "" : "text-destructive"), children: r.email }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-muted-foreground", children: r.union || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: overrideUnion }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-muted-foreground", children: r.dob ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-muted-foreground", children: r.joiningDate ?? "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2", children: ok ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-success text-xs", children: "Valid" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive text-xs", children: "Invalid" }) })
            ] }, i);
          }) })
        ] }) }),
        rows.length > 200 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center text-xs text-muted-foreground p-3 border-t border-glass-border", children: [
...
function Dropzone({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { onDragOver: (e) => {
    e.preventDefault();
    setDrag(true);
    ...
    if (f) onFile(f);
  }, className: "glass rounded-2xl p-10 flex flex-col items-center justify-center text-center cursor-pointer border-2 border-dashed transition-all " + (drag ? "border-secondary bg-secondary/10 shadow-glow" : "border-glass-border hover:border-secondary/50"), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl gradient-primary flex items-center justify-center shadow-glow mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "w-6 h-6 text-primary-foreground" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-semibold", children: [
      "Drop your ",
      kind,
      " file here"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1", children: "or click to browse" }),
