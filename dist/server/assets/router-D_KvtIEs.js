...
var Route$5 = class Route extends BaseRoute {
  ...
  */
  constructor(options) {
    ...
    this.Link = React.forwardRef((props, ref2) => {
...
const appCss = "/assets/styles-B1hPZrvj.css";
const AppContext = reactExports.createContext(void 0);
function AppProvider({ children }) {
  const [union, setUnion] = reactExports.useState("All");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppContext.Provider, { value: { union, setUnion, theme, toggleTheme }, children });
}
function useApp() {
...
const formDataToStream = (form, headersHandler, options) => {
  const {
    ...
    size: size2 = 25,
    boundary = tag + "-" + platform$1.generateString(size2, BOUNDARY_ALPHABET)
  } = options || {};
...
const API_BASE_URL = "https://unionwisher.onrender.com";
const api = axios.create({
  baseURL: API_BASE_URL,
  timeout: 3e4,
  headers: { "Content-Type": "application/json" }
});
const UNIONS = ["All", "Union A", "Union B", "Union C"];
const normalize = (e) => ({
  ...e,
  id: e._id || e.id
});
const isToday = (date) => {
  ...
  return d.toLocaleDateString("en-CA", { timeZone: "Asia/Kolkata" }) === today.toLocaleDateString("en-CA", { timeZone: "Asia/Kolkata" });
};
const fetchEmployees = async (union) => {
...
const getTodayBirthdaysInternal = (employees) => employees.filter((e) => e.dob && isToday(e.dob)).map((e) => ({ ...e, type: "birthday" }));
const getTodayAnniversariesInternal = (employees) => employees.filter((e) => e.joiningDate && isToday(e.joiningDate)).map((e) => ({ ...e, type: "anniversary" }));
const fetchBirthdaysToday = async (union) => {
  const data = await fetchEmployees(union);
  return getTodayBirthdaysInternal(data);
};
const fetchAnniversariesToday = async (union) => {
  const data = await fetchEmployees(union);
  return getTodayAnniversariesInternal(data);
};
const sendWish = async (payload) => {
...
const uploadTemplate = async (file, type2, name) => {
  const fd = new FormData();
  fd.append("file", file);
  ...
  var ref2 = reactExports.useState(function() {
    return {
      ...
      facade: {
        ...
        set current(value) {
          var last2 = ref2.value;
          if (last2 !== value) {
            ref2.value = value;
            ref2.callback(value, last2);
          }
        }
      }
    };
...
const Button = reactExports.forwardRef(
  ({ className, variant, size: size2, asChild = false, ...props }, ref2) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Comp, { className: cn$1(buttonVariants({ variant, size: size2, className })), ref: ref2, ...props });
  }
);
...
const NAV = [
  ...
  { to: "/templates", label: "Templates", icon: Image }
];
function AppShell({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden lg:flex w-64 flex-col glass-strong border-r border-glass-border p-5 gap-2 sticky top-0 h-screen", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3 mb-6 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl gradient-primary flex items-center justify-center shadow-glow group-hover:scale-110 transition-transform", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-5 h-5 text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-lg leading-tight text-gradient-primary", children: "UnionWisher" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-muted-foreground", children: "Admin Console" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-1", children: NAV.map(({ to, label, icon: Icon2 }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            className: cn$1(
              ...
              active ? "gradient-primary text-primary-foreground shadow-glow" : "text-muted-foreground hover:text-foreground hover:bg-glass"
            ),
            children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto glass rounded-xl p-4 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gradient-gold font-semibold mb-1", children: "UnionWisher" }),
        "Automate Wishes. Strengthen Connections."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 glass-strong border-b border-glass-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 lg:px-8 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "lg:hidden flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg gradient-primary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-gradient-primary", children: "UnionWisher" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-2 ml-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "w-4 h-4 text-muted-foreground" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: "Union" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: union, onValueChange: (v) => setUnion(v), children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "All", children: "All Unions" }),
              UNIONS.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: u, children: u }, u))
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: toggleTheme, "aria-label": "Toggle theme", children: theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "w-4 h-4" }) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden flex gap-1 px-2 pb-2 overflow-x-auto", children: NAV.map(({ to, label, icon: Icon2 }) => {
          const active = location.pathname === to || to !== "/" && location.pathname.startsWith(to);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 px-4 lg:px-8 py-6 lg:py-8", children })
    ] })
  ] });
}
...
const Toaster$1 = /* @__PURE__ */ React.forwardRef(function Toaster(props, ref2) {
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-10 max-w-md text-center shadow-elevated", children: [
...
const $$splitComponentImporter$3 = () => import("./upload-WQHH1mN9.js");
const Route$3 = createFileRoute("/upload")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./templates-DtODxZG4.js");
const Route$2 = createFileRoute("/templates")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./employees-DICxSzMr.js");
const Route$1 = createFileRoute("/employees")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-7DIncpIF.js");
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const UploadRoute = Route$3.update({
  id: "/upload",
  path: "/upload",
  getParentRoute: () => Route$4
});
const TemplatesRoute = Route$2.update({
  id: "/templates",
  path: "/templates",
  getParentRoute: () => Route$4
});
const EmployeesRoute = Route$1.update({
  id: "/employees",
  path: "/employees",
  getParentRoute: () => Route$4
});
